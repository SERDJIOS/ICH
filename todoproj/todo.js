...
// По клику на getAll кнопка getAll исчезает и появляется кнопка removeAll
// По клику на removeAll исчезают все элементы
// 2 на что обращаем внимание - укажите явно кнопкам тип внутри формы
